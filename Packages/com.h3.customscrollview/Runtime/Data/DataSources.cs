...
namespace CustomScrollView.Data
{
    ...
    /// </summary>
    public sealed class SimpleDataSource : IScrollDataSource
    {
        ...
        /// </summary>
        public int AddSection(float headerSize = 0f, float footerSize = 0f)
        {
    ...
    /// </summary>
    public sealed class DelegateDataSource : IScrollDataSource
    {
